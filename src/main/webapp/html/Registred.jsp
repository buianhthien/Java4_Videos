		...
		<form action="register" method="post">
			<div class="card" style="width: 500px">
				<div class="card-body border bg-success-subtle">
					<h5 class="card-title text-dark fw-bolder fs-4">Registration</h5>
				</div>
				...
				<div class="row">
					...
					<div class="col-6">
						<div class="p-2">
							<label for="email" class="form-label">Email Address:</label> <input
								...
								placeholder="Vui lòng nhập Email Address" />
						</div>
					</div>
					<div class="ms-3 mb-2">
					...
					<div class="ms-3 mb-2 ">
						Bạn đã có tài khoản?<a class="text-decoration-none"
							href="/ASSJAVA4_PD10303/login">Đăng nhập ngay</a>
					</div>
				</div>
		</form>
	</main>
